            ...
            <form onSubmit={handleSubmit} className="flex flex-col mt-6 gap-4">
              <div className="flex justify-between">
                <span className="text-4xl font-bold">
                  Editing{" "}
                  <span className="underline">{device[`device_name`]}</span>
                </span>
                <button
                  className="bg-green-300 rounded px-5 py-3 uppercase font-bold"
                  type="submit"
                >
                  Submit
                </button>
              ...
              <div className="flex flex-col">
                <label htmlFor="device_name" className="text-gray-600 ps-3">
                  Device Name
                </label>
                <input
                  type="text"
                  className="px-3 py-1 text-xl bg-slate-100 rounded-tl-md rounded-tr-md border-b-2 border-black"
                  name="device_name"
                  id="device_name"
              ...
              <div className="flex flex-col">
                <label htmlFor="location" className="text-gray-600 ps-3">
                  Location
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col mt-3">
                <p className="text-lg font-bold">Sockets</p>
...
const Frame = ({ children, title }) => {
  ...
  return (
    <div className="flex flex-col border rounded bg-gray-100 mt-2">
      <p className="text-sm font-medium px-4 cursor-pointer" onClick={handleExpandFrame}>{title} <FontAwesomeIcon icon={faChevronRight} className={`${frameExpanded ? "rotate-90" : ""} transition-all ml-2`}/></p>
      <div className={`overflow-hidden transition-all ease ${!frameExpanded ? "max-h-full" : "max-h-0"}`}>
        {children}
      </div>
    </div>
  );
